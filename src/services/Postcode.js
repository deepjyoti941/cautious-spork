...
const API_URL =
  'https://services.postcodeanywhere.co.uk/CapturePlus/Interactive/Find/v2.00/json3ex.ws';
const API_RESULT_URL =
  'https://services.postcodeanywhere.co.uk/CapturePlus/Interactive/RetrieveFormatted/v2.00/json3ex.ws';
...
const PostCode = {
  ...
  formattAddress: addressParam => {
    ...
    //TODO: Use Lodash and ES6.

    for (i; i < keyNameArrLength; i++) {
